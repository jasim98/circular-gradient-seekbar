package com.jasim.circulargradientseekbar;
...
public class CircularSeekBar  extends View {
    ...
    protected static final int DEFAULT_CIRCLE_PROGRESS_COLOR = Color.argb(255, 74, 138, 255);
    protected static final int DEFAULT_CIRCLE_PROGRESS_START_COLOR = Color.argb(255, 161,238,245);
    protected static final int DEFAULT_CIRCLE_PROGRESS_END_COLOR = Color.argb(255, 250,213,147);
    protected static final int DEFAULT_POINTER_COLOR = Color.WHITE;
    protected static final int DEFAULT_GRADIENT_ANGLE = -1;
    protected static final int DEFAULT_POINTER_HALO_STYLE = 0;
    protected static final int DEFAULT_POINTER_HALO_COLOR = Color.WHITE;
    protected static final int DEFAULT_POINTER_HALO_COLOR_ONTOUCH = Color.WHITE;
    ...
    protected int mCircleProgressGradientStartColor = DEFAULT_CIRCLE_PROGRESS_START_COLOR;

    protected int mCircleProgressGradientEndColor = DEFAULT_CIRCLE_PROGRESS_END_COLOR;

    protected int mCircleGradientStartColor = DEFAULT_CIRCLE_PROGRESS_START_COLOR;

    protected int mCircleGradientEndColor = DEFAULT_CIRCLE_PROGRESS_END_COLOR;

    protected int mCircleGradientAngle = DEFAULT_GRADIENT_ANGLE;

    protected int mCircleProgressGradientAngle = DEFAULT_GRADIENT_ANGLE;

    protected int mPointerHaloStyle = DEFAULT_POINTER_HALO_STYLE;
    /**
    ...
    protected void initAttributes(TypedArray attrArray) {
        ...
        mCircleGradientStartColor = attrArray.getColor(R.styleable.CircularSeekBar_circle_gradient_start_color, DEFAULT_CIRCLE_PROGRESS_START_COLOR);
        mCircleGradientEndColor = attrArray.getColor(R.styleable.CircularSeekBar_circle_gradient_end_color, DEFAULT_CIRCLE_PROGRESS_END_COLOR);
        mCircleProgressGradientStartColor = attrArray.getColor(R.styleable.CircularSeekBar_circle_progress_gradient_end_color, DEFAULT_CIRCLE_PROGRESS_END_COLOR);
        mCircleProgressGradientEndColor = attrArray.getColor(R.styleable.CircularSeekBar_circle_progress_gradient_start_color, DEFAULT_CIRCLE_PROGRESS_START_COLOR);
        mPointerHaloStyle = attrArray.getInt(R.styleable.CircularSeekBar_pointer_halo_style, DEFAULT_POINTER_HALO_STYLE);
        mPointerAlpha = Color.alpha(mPointerHaloColor);
        mCircleGradientAngle = attrArray.getInt(R.styleable.CircularSeekBar_circle_gradient_angle, DEFAULT_GRADIENT_ANGLE);
        mCircleProgressGradientAngle = attrArray.getInt(R.styleable.CircularSeekBar_circle_progress_gradient_angle, DEFAULT_GRADIENT_ANGLE);
...
//        if(mCircleGradientStartColor == DEFAULT_CIRCLE_PROGRESS_START_COLOR && mCircleGradientEndColor == DEFAULT_CIRCLE_PROGRESS_END_COLOR){
//
//        }else {
////            mCirclePaint.setColor(mCircleColor);
//            mCirclePaint.setShader(new LinearGradient((float) (getHeight()/3.391724860264469), 0, 0, 0, mCircleGradientEndColor, mCircleGradientStartColor, Shader.TileMode.CLAMP));
//        }
...
//            mCircleProgressPaint.setColor(mCircleProgressColor);
//        } else {
//            mCircleProgressPaint.setShader(new LinearGradient((float) (getHeight() / 3.391724860264469), 0, 0, 0, mCircleProgressGradientEndColor, mCircleProgressGradientStartColor, Shader.TileMode.CLAMP));
//        }
        ...
        if(mPointerHaloStyle == 0){
            mPointerHaloPaint.setStyle(Paint.Style.STROKE);
        }else if(mPointerHaloStyle == 1){
            mPointerHaloPaint.setStyle(Paint.Style.FILL);
        }
...
//        mPointerHaloPaint.setStrokeWidth(mPointerRadius + mPointerHaloWidth);
        ...
        Log.d("Color123", mCircleProgressGradientStartColor + "Next Value : " + DEFAULT_CIRCLE_PROGRESS_END_COLOR);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(mCircleGradientStartColor != DEFAULT_CIRCLE_PROGRESS_START_COLOR && mCircleGradientEndColor != DEFAULT_CIRCLE_PROGRESS_END_COLOR){
            if(mCircleGradientAngle != DEFAULT_GRADIENT_ANGLE){
                mCirclePaint.setShader(new LinearGradient((float) ((getHeight()/144) * mCircleGradientAngle * 2), 0, 0, 0, mCircleGradientEndColor, mCircleGradientStartColor, Shader.TileMode.CLAMP));
            }else{
                mCirclePaint.setShader(new LinearGradient((float) ((getHeight()/144)), 0, 0, 0, mCircleGradientEndColor, mCircleGradientStartColor, Shader.TileMode.CLAMP));
            }
        }
        if (mCircleProgressGradientStartColor != DEFAULT_CIRCLE_PROGRESS_START_COLOR && mCircleProgressGradientEndColor != DEFAULT_CIRCLE_PROGRESS_END_COLOR) {
            if(mCircleProgressGradientAngle != DEFAULT_GRADIENT_ANGLE){
                mCircleProgressPaint.setShader(new LinearGradient((float) ((getHeight()/144) * mCircleProgressGradientAngle * 2), 0, 0, 0, mCircleProgressGradientEndColor, mCircleProgressGradientStartColor, Shader.TileMode.CLAMP));
            }else{
                mCircleProgressPaint.setShader(new LinearGradient((float) ((getHeight()/144)), 0, 0, 0, mCircleProgressGradientEndColor, mCircleProgressGradientStartColor, Shader.TileMode.CLAMP));
            }
        }
        ...
        Log.d("position1", String.valueOf(getHeight()));
...
//        int pixel = (int) Color.red(mPointerPositionXY[0], mPointerPositionXY[1]);
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        state.putInt("mCircleGradientStartColor", mCircleGradientStartColor);
        state.putInt("mCircleGradientEndColor", mCircleGradientEndColor);
        state.putInt("mCircleProgressGradientStartColor", mCircleProgressGradientStartColor);
        state.putInt("mCircleProgressGradientEndColor", mCircleProgressGradientEndColor);
        ...
        state.putInt("mPointerHaloStyle", mPointerHaloStyle);
        state.putInt("mCircleGradientAngle", mCircleGradientAngle);
        state.putInt("mCircleProgressGradientAngle", mCircleProgressGradientAngle);
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        mCircleGradientStartColor = savedState.getInt("mCircleGradientStartColor");
        mCircleGradientEndColor = savedState.getInt("mCircleGradientEndColor");
        mCircleProgressGradientStartColor = savedState.getInt("mCircleProgressGradientStartColor");
        mCircleProgressGradientEndColor = savedState.getInt("mCircleProgressGradientEndColor");
        ...
        mPointerHaloStyle = savedState.getInt("mPointerHaloStyle");
        mCircleGradientAngle = savedState.getInt("mCircleGradientAngle");
        mCircleProgressGradientAngle = savedState.getInt("mCircleProgressGradientAngle");
        initPaints();
    ...
    public void setCircleGradientStartAndEndColor(int startColor, int endColor) {
        mCircleGradientStartColor = startColor;
        mCircleGradientEndColor = endColor;
        if (mCircleGradientAngle != DEFAULT_GRADIENT_ANGLE) {
            mCirclePaint.setShader(new LinearGradient((float) ((getHeight() / 144) * mCircleGradientAngle * 2), 0, 0, 0, mCircleGradientEndColor, mCircleGradientStartColor, Shader.TileMode.CLAMP));
        } else {
            mCirclePaint.setShader(new LinearGradient((float) ((getHeight() / 144)), 0, 0, 0, mCircleGradientEndColor, mCircleGradientStartColor, Shader.TileMode.CLAMP));
    ...
    public int getCircleGradientStartColor() {
        return mCircleGradientStartColor;
    }

    public int getCircleGradientEndColor() {
        return mCircleGradientEndColor;
    }

    public void setCircleProgressGradientStartAndEndColor(int startColor, int endColor) {
        mCircleProgressGradientStartColor = startColor;
        mCircleProgressGradientEndColor = endColor;
        if(mCircleProgressGradientAngle != DEFAULT_GRADIENT_ANGLE){
            mCircleProgressPaint.setShader(new LinearGradient((float) ((getHeight()/144) * mCircleProgressGradientAngle * 2), 0, 0, 0, mCircleProgressGradientEndColor, mCircleProgressGradientStartColor, Shader.TileMode.CLAMP));
        }else{
            mCircleProgressPaint.setShader(new LinearGradient((float) ((getHeight()/144)), 0, 0, 0, mCircleProgressGradientEndColor, mCircleProgressGradientStartColor, Shader.TileMode.CLAMP));
    ...
    public int getCircleProgressGradientStartColor() {
        return mCircleProgressGradientStartColor;
    }

    public int getCircleProgressGradientEndColor() {
        return mCircleProgressGradientEndColor;
    }

    public void setCircleProgressGradientAngle(int angle) {
        mCircleProgressGradientAngle = angle;
        invalidate();
    }

    public void setCircleGradientAngle(int angle) {
        mCircleGradientAngle = angle;
        invalidate();
    }

    public int getCircleProgressGradientAngle() {
        return mCircleProgressGradientAngle;
    }

    public int getCircleGradientAngle() {
        return mCircleGradientAngle;
    }
    ...
    public void setPointerHaloStyle(int style) {
        if(style == 0 || style == 1){
            mPointerHaloStyle = style;
            if(style == 0){
                mPointerHaloPaint.setStyle(Paint.Style.STROKE);
            }else {
                mPointerHaloPaint.setStyle(Paint.Style.FILL);
